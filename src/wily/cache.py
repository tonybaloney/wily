...
def store(config: WilyConfig, archiver: Archiver, revision: Revision, stats: Dict) -> pathlib.Path:
    """
...
def store_archiver_index(config: WilyConfig, archiver: Archiver, index: Dict) -> pathlib.Path:
    """
